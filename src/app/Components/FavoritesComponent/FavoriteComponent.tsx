...
const [smallWeatherIcon, setSmallWeatherIcon] = useState<any>(SunnySmall);
...
const StateIntoAB = (state: string) => {
  ...
  return (
    <div className="bg-[#5193DE] py-[10px] pl-[15px] pr-[10px] text-white font-[Inter] mt-[20px]" onClick={handleClick}>
      <div className="flex justify-between mb-[6px] items-center">
        <p className="text-[20px]">{`${name}, ${stateVar}`}</p>
        <div className="flex items-center">
          <p className="text-[20px]">{temp}°F</p>
          <Image src={RemoveFav} onClick={handleRemove} alt="Minus Fav" />
        </div>
      </div>
      <div className="flex justify-between">
        <div className="flex items-center">
          <Image src={smallWeatherIcon} alt="CloudySmall" />
